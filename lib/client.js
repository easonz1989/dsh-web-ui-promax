	...
	factory: (require) => {
		...
		const dict = {
			en: {
				...
				original: "Original UI",
				originalHint: "Harness native appearance with no ProMax visual overrides.",
				ios: "iOS",
			...
			zh: {
				...
				uiEffects: "UI 特效",
				original: "原生界面",
				originalHint: "使用 Harness 原生外观，不应用 ProMax 视觉覆盖。",
				ios: "iOS",
...
`;
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: [{
							...
							label: t("ios"),
							hint: t("iosHint")
						}].map((option) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							className: `promax-effect-cube ${current === option.id ? "promax-effect-selected" : ""}`,
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: `promax-effect-preview ${option.id === "original" ? "promax-effect-preview-original" : ""}`,
									"aria-hidden": true
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		function applyUiEffect(root, effect) {
			if (effect === "original") delete root.dataset["dshUiEffect"];
			else root.dataset["dshUiEffect"] = effect;
		}
