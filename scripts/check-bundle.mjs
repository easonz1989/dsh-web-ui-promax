...
for (const marker of ['dsh-web-ui-promax', 'llm-pi-ai', 'reasoningEfforts', 'supportsReasoningEffort', 'deepseek', '/web-ui-promax', 'uiEffect', 'ios']) {
...
for (const marker of ['dsh-web-ui-promax', 'conversation.input.right', 'settings.general.item', 'Reasoning', '推理', 'UI Effects', 'UI 特效', 'Swift Glass', 'Liquid Glass', 'More effects coming soon', 'modelDirectories']) {
